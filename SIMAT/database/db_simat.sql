-- ========================================================
-- DB SIMAT - Import Ready for phpMyAdmin Laragon/XAMPP
-- Generated from: db_simat.sql
-- Notes:
-- 1. Creates database `db_simat` automatically.
-- 2. Removes DEFINER clauses for portability.
-- 3. Drops existing routines/tables before recreating them.
-- 4. Temporarily disables foreign key checks during import.
-- ========================================================
...
--
-- Host: localhost:3306
-- Generation Time: Jun 26, 2026 at 01:09 AM
...
-- --------------------------------------------------------
-- Portable import setup for phpMyAdmin Laragon/XAMPP
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Drop existing routines so the file can be imported repeatedly
-- --------------------------------------------------------
...
(5, 2, 1, '0920250039', 'Mikael', 'mikael@gmail.com', '081298394420', '0.00', '0.00', '0.00', '25.00', 'Aktif'),
...
(13, 2, 1, '9', 'Hailkal', '', '', '0.00', '0.00', '100.00', '0.00', 'Aktif');
...
--
ALTER TABLE `detail_pengguna_pada_pengajuan_jam_plus`
  MODIFY `id_detail_pengguna_pada_pengajuan_jam_plus` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `pengajuan_jam_plus`
  MODIFY `id_pengajuan_jam_plus` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
